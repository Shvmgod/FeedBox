    ...
    <div className="navbar-navbar-container">
      <header data-role="Header" className="navigation-container">
        ...
        <div className="navbar-nav1">
          <NavigationLinks rootClassName="navigation-linksroot-class-name10"></NavigationLinks>
        </div>
        ...
        <div data-role="MobileMenu" className="navigation-mobile-menu">
          <div className="navbar-nav2">
            ...
            <NavigationLinks rootClassName="navigation-linksroot-class-name11"></NavigationLinks>
        ...
        <button className="button-primary button navbar-primary-btn2">
          {props.primaryBtn}
        </button>
      </header>
    </div>
