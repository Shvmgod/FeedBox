      ...
      <div className="footer-max-width max-content-container">
        ...
        <div className="footer-links">
          <div className="footer-container3">
            ...
            <span className="footer-text17 footer-link">Pricing</span>
          </div>
          <div className="footer-container4">
            <span className="footer-text18">Resources</span>
            ...
            <span className="footer-text23 footer-link">Android Version</span>
          </div>
        </div>
      </div>
    </footer>
